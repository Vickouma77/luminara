...
async fn main() -> std::io::Result<()> {
    ...
    tracing::info!("  - Account Service: {}", config.services.account_service_url);
    tracing::info!("  - Transaction Service: {}", config.services.transaction_service_url);
    tracing::info!("  - KYC Service: {}", config.services.kyc_service_url);
    tracing::info!("  - Payment Service: {}", config.services.payment_service_url);
