...
fn test_config_has_correct_defaults() {
    ...
    assert_eq!(config.services.transaction_service_url, "http://localhost:8004");
    assert_eq!(config.services.kyc_service_url, "http://localhost:8005");
    assert_eq!(config.services.notification_service_url, "http://localhost:8006");
...
fn test_config_clone() {
    ...
    assert_eq!(config.services.auth_service_url, cloned.services.auth_service_url);
}
